...
#define RTOS_LOWEST_PRIORITY             (RHINO_CONFIG_PRI_MAX-1)
...
typedef aos_sem_t   /*@abstract@*/ /*@only@*/ host_semaphore_type_t;  /** FreeRTOS definition of a semaphore */
typedef aos_mutex_t   /*@abstract@*/ /*@only@*/ host_mutex_type_t;  /** FreeRTOS definition of a mutex */
typedef aos_task_t        /*@abstract@*/ /*@only@*/ host_thread_type_t;     /** FreeRTOS definition of a thread handle */
typedef aos_queue_t       /*@abstract@*/ /*@only@*/ host_queue_type_t;      /** FreeRTOS definition of a message queue */
