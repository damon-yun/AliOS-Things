...
#define RTOS_NAME                     "AliOS Things"
#define RTOS_VERSION                  "V1.20"
...
typedef int wiced_event_flags_t;
typedef host_semaphore_type_t wiced_semaphore_t;

typedef aos_mutex_t wiced_mutex_t;

typedef void (*timer_handler_t)( void* arg,void* arg1 );

typedef aos_timer_t wiced_timer_t;

typedef aos_task_t wiced_thread_t;

typedef aos_queue_t wiced_queue_t;
